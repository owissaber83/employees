...
window.renderDisciplinary = function () {
    ...
    c.innerHTML = `<div style="padding:0 4px">
        ...
        return `<tr style="border-bottom:1px solid #f3f3f3">
                    ...
                    <td><span style="background:color-mix(in srgb, ${t.color} 9.41%, transparent);color:${t.color};padding:2px 8px;border-radius:8px;font-size:11px;font-weight:700">${t.label}</span></td>
