      ...
      sections: [
        {
          ...
          lines: [
            L('The objective of general-purpose financial reporting is to provide information useful for decisions about supplying resources to the entity.',
              'هدف التقارير المالية ذات الغرض العام تقديم معلومات <strong>مفيدة لقرارات تخصيص الموارد</strong> للمنشأة (استثمار/إقراض). فالقوائم أداة قرار، لا غاية في ذاتها.'),
            L('It reports the entity’s economic resources and claims (position) and the changes in them (performance).',
              'تُظهر <strong>الموارد الاقتصادية والمطالبات عليها</strong> (= المركز المالي) و<strong>التغيّرات</strong> فيها (= الأداء)، لتقييم السيولة والملاءة والحاجة للتمويل واحتمال الحصول عليه.'),
            L('External users (investors, creditors, analysts, regulators) are the primary users; internal users also rely on the statements.',
              'المستخدمون <strong>الخارجيون</strong> هم الأساسيون: المستثمرون، الدائنون، المحللون، البورصات، الجهات التنظيمية. ويستخدمها <strong>الداخليون</strong> أيضًا (الإدارة، الموظفون، مجلس الإدارة).'),
            L('For external statements to be useful they must follow generally accepted accounting principles (U.S. GAAP). If a question does not distinguish GAAP from IFRS, use GAAP.',
              'لكي تكون مفيدة يجب إعدادها وفق المبادئ المحاسبية المقبولة عمومًا <strong>GAAP</strong>. وإن لم يفرّق سؤال الامتحان بين GAAP و IFRS <strong>استخدم GAAP</strong>.'),
            L('Financial accounting serves external users under GAAP and is historical; management accounting serves internal users and looks forward.',
              '<strong>المالية</strong>: مستخدمون خارجيون + GAAP + تاريخية. <strong>الإدارية</strong>: الإدارة الداخلية + موجّهة للمستقبل (وتُغطّى في الوحدات 7–16).'),
            L('Notes are part of the basic financial statements; the first note usually describes significant accounting policies.',
              '<strong>الإيضاحات جزء أساسي</strong> من القوائم توسّع وتشرح المبالغ المسجّلة؛ وأول إيضاح يصف عادةً <strong>السياسات المحاسبية الهامة</strong> (التقديرات، الاعتراف بالإيراد، توزيع تكلفة الأصول).'),
            L('A full set is five statements, prepared under the going-concern and accrual assumptions.',
              'المجموعة الكاملة = <strong>خمس قوائم</strong> (مركز مالي، دخل، دخل شامل، تغيّرات حقوق ملكية، تدفقات نقدية) على افتراض <strong>الاستمرارية (Going-concern)</strong> و<strong>الاستحقاق</strong>.'),
            L('Statements complement each other and articulate: net income ties to retained earnings; ending inventory and depreciation link the income statement to the balance sheet.',
              'القوائم <strong>مترابطة (Articulation)</strong>: صافي الدخل يُرحَّل للأرباح المحتجزة؛ النقد يُطابَق مع قائمة التدفقات؛ حقوق الملكية تُطابَق مع قائمة التغيّرات؛ ومخزون آخر المدة والإهلاك يربطان الدخل بالمركز المالي.'),
            L('Under accrual accounting, revenue is recognized when earned and expenses when incurred (matching), not when cash moves. The cash basis is not GAAP.',
              'في <strong>الاستحقاق</strong>: الإيراد عند اكتسابه والمصروف عند تكبّده مع مبدأ <strong>المقابلة</strong> — لا عند حركة النقد. <strong>الأساس النقدي غير مقبول</strong> وفق GAAP.'),
          ],
          note: 'الخصائص النوعية: الملاءمة (Relevance) والتمثيل الصادق (Faithful Representation) أساسيتان، تعزّزهما القابلية للمقارنة والتحقّق والتوقيت والفهم. مبادئ الاعتراف بالمصروف: السبب والنتيجة، التوزيع المنتظم والمنطقي، والاعتراف الفوري.'
        },
        {
          ...
          lines: [
            L('The balance sheet reports assets, liabilities, and equity at a point in time: Assets = Liabilities + Equity.',
              'تعرض الأصول والخصوم وحقوق الملكية في <strong>لحظة زمنية</strong> محددة (نهاية السنة مثلًا)، ومعادلتها: <strong>الأصول = الخصوم + حقوق الملكية</strong> (نظرية الصندوق). واشتقاقها: الأصول − الخصوم = حقوق الملكية (نظرية الملكية).'),
            L('Assets are resources controlled from past events with probable future benefits; liabilities are present obligations expected to cause outflows; equity is the residual.',
              '<strong>الأصول</strong> موارد يسيطر عليها الكيان من أحداث ماضية بمنافع مستقبلية محتملة. <strong>الخصوم</strong> التزامات حالية يُتوقع أن تُسدَّد بتدفق خارج. <strong>حقوق الملكية</strong> = المتبقي بعد خصم كل الخصوم.'),
            L('Assets and liabilities are split into current and noncurrent using the one-year or operating-cycle rule (whichever is longer).',
              'تُصنَّف إلى <strong>متداولة وغير متداولة</strong> حسب قاعدة السنة أو <strong>الدورة التشغيلية</strong> أيهما أطول: متداول = يُحقَّق/يُسدَّد خلال تلك الفترة. والأصول تُرتَّب عادةً حسب <strong>السيولة</strong>.'),
            L('Current assets: cash & equivalents, certain investments/receivables, inventory, prepaid expenses. Noncurrent: long-term investments, PPE, intangibles.',
              '<strong>الأصول المتداولة</strong>: النقد وما في حكمه، بعض الاستثمارات والمدينون، المخزون، المصروفات المدفوعة مقدمًا. <strong>غير المتداولة</strong>: الاستثمارات طويلة الأجل، الممتلكات والمصانع والمعدات PPE (بالتكلفة صافيةً من مجمع الإهلاك)، والأصول غير الملموسة (كبراءات الاختراع والشهرة).'),
            L('Current liabilities: payables, accrued wages/taxes, unearned revenue, current portion of long-term debt. Short-term debt to be refinanced long-term may be noncurrent.',
              '<strong>الخصوم المتداولة</strong>: الدائنون، أجور/ضرائب مستحقة، إيرادات غير مكتسبة (مقدمة)، والقسط المتداول من الديون طويلة الأجل. ويُستثنى الدين قصير الأجل إذا كان الكيان ينوي ويستطيع <strong>إعادة تمويله</strong> على أساس غير متداول.'),
            L('Equity items: contributed capital (par of common/preferred + APIC), retained earnings, treasury stock (contra), and accumulated OCI.',
              '<strong>حقوق الملكية</strong>: رأس المال المُساهَم (القيمة الاسمية للأسهم + <strong>علاوة الإصدار APIC</strong>)، الأرباح المحتجزة، أسهم الخزينة (حساب مقابل يُخفِّض الإجمالي)، والدخل الشامل الآخر المتراكم.'),
            L('It reveals liquidity, financial flexibility, and solvency. Working capital = current assets − current liabilities.',
              'تكشف <strong>السيولة والمرونة المالية والملاءة</strong>. و<strong>رأس المال العامل = الأصول المتداولة − الخصوم المتداولة</strong>.'),
          ],
          note: 'قيود الميزانية: تُظهر المركز في لحظة واحدة قد تتغيّر بعدها؛ كثير من البنود (كـ PPE) بالتكلفة التاريخية لا القيمة العادلة؛ تعتمد تقديرات وأحكامًا؛ وتُغفل بنودًا ذات قيمة لا يمكن قياسها بموضوعية (كالعلامة المطوّرة ذاتيًا).'
        },
        {
          c: '1.3', title: 'Income Statement, COGS & Comprehensive Income', ar: 'قائمة الدخل وتكلفة المبيعات والدخل الشامل',
          lines: [
            L('The income statement reports performance over a period: Income = Revenues + Gains − Expenses − Losses.',
              'تقيس الأداء <strong>خلال فترة</strong>: صافي الدخل = <strong>الإيرادات + المكاسب − المصروفات − الخسائر</strong>. (الإيرادات/المصروفات من النشاط الرئيسي؛ المكاسب/الخسائر من غيره.)'),
            L('For a retailer: Beginning inventory + net purchases + freight-in − ending inventory = Cost of Goods Sold.',
              'لتاجر التجزئة: <strong>تكلفة البضاعة المباعة</strong> = مخزون أول المدة + صافي المشتريات + مصاريف نقل المشتريات − مخزون آخر المدة.'),
            L('A manufacturer first computes Cost of Goods Manufactured, then adds/subtracts finished-goods inventory to get COGS.',
              'المُصنِّع يحسب أولًا <strong>تكلفة البضاعة المصنَّعة</strong> (مواد مباشرة مستخدمة + عمالة مباشرة + تكاليف صناعية غير مباشرة، مع تسوية مخزون تحت التشغيل)، ثم يسوّي مخزون البضاعة التامة ليصل لتكلفة البضاعة المباعة.'),
            L('Gross profit = Sales − COGS; Gross profit margin = Gross profit ÷ Sales.',
              '<strong>مجمل الربح = المبيعات − تكلفة المبيعات</strong>؛ و<strong>هامش مجمل الربح (%) = مجمل الربح ÷ المبيعات</strong>.'),
            L('Single-step groups all revenues and all expenses (one subtraction); multiple-step separates operating from nonoperating and shows gross profit.',
              'الشكل <strong>أحادي الخطوة</strong> يجمع كل الإيرادات وكل المصروفات بطرح واحد. الشكل <strong>متعدد الخطوات</strong> يفصل التشغيلي عن غير التشغيلي ويُظهر مجمل الربح ودخل العمليات — وهو الأشيَع (بصيغته المختصرة).'),
            L('Discontinued operations are reported separately, net of tax, between income from continuing operations and net income.',
              '<strong>العمليات غير المستمرة</strong> تُعرض منفصلة <strong>بعد الضريبة</strong> بين دخل العمليات المستمرة وصافي الدخل. وتشمل: ربح/خسارة تشغيل المكوّن، وربح/خسارة التخلص منه.'),
            L('Comprehensive income = net income + other comprehensive income (OCI), shown in one continuous statement or two consecutive statements.',
              '<strong>الدخل الشامل = صافي الدخل + الدخل الشامل الآخر (OCI)</strong>؛ يُعرض في <strong>قائمة واحدة متصلة</strong> أو <strong>قائمتين متتاليتين</strong>.'),
          ],
          note: 'مثال محلول (COGM/COGS): مواد مستخدمة = 65,000 + 240,000 − 58,000 = 247,000؛ + عمالة مباشرة 300,000 + غير مباشرة 105,000 = إجمالي تكاليف تصنيع 652,000؛ + WIP أول 100,000 − WIP آخر 120,000 = تكلفة بضاعة مصنَّعة 632,000؛ + تام أول 30,000 − تام آخر 26,000 = تكلفة بضاعة مباعة 636,000. • مثال قائمة دخل متعددة الخطوات: مبيعات 200,000 − COGS 150,000 = مجمل ربح 50,000 − بيعية 6,000 − إدارية 5,000 = دخل عمليات 39,000 + إيرادات أخرى 3,500 − مصروفات أخرى 2,500 = دخل قبل الضريبة 40,000 − ضريبة 16,000 = صافي الدخل 24,000. • بنود OCI: فروق ترجمة العملات الأجنبية، الجزء الفعّال من تحوّط التدفق النقدي، أرباح/خسائر حيازة غير محققة لأوراق الدين المتاحة للبيع، وبعض تعديلات خطط المعاشات محددة المزايا.'
        },
        {
          c: '1.4', title: 'Changes in Equity & Equity Transactions', ar: 'التغيّرات في حقوق الملكية ومعاملاتها',
          lines: [
            L('The statement of changes in equity reconciles the beginning and ending balance of each equity component separately.',
              'تُطابِق رصيد <strong>أول وآخر المدة</strong> لكل بند من حقوق الملكية مع الإفصاح عن كل تغيّر على حدة (رأس المال، APIC، الأرباح المحتجزة، أسهم الخزينة، OCI المتراكم).'),
            L('Retained earnings = beginning RE + net income (− loss) − dividends ± prior-period adjustments.',
              '<strong>الأرباح المحتجزة = أول المدة + صافي الدخل (− الخسارة) − التوزيعات ± تسويات الفترات السابقة</strong>؛ وهي حلقة الوصل بين قائمة الدخل والميزانية.'),
            L('Stock terms: authorized (max issuable), issued (sold), outstanding (held by shareholders). Common holders vote and have preemptive rights.',
              'مصطلحات الأسهم: <strong>مصرَّح به</strong> (الحد الأقصى للإصدار)، <strong>مُصدَر</strong> (بيع للمساهمين)، <strong>قائم Outstanding</strong> (بحوزة المساهمين). حملة العادي يملكون <strong>حق التصويت</strong> و<strong>حق الأولوية</strong> في الاكتتاب.'),
            L('Preferred stock has debt/equity features: fixed-rate dividends (if declared) before common, priority in liquidation, usually no vote; may be cumulative or convertible.',
              '<strong>الأسهم الممتازة</strong> تجمع خصائص الدين والملكية: أرباح بمعدل ثابت (إن أُعلنت) قبل العادي، أولوية في التصفية بعد الدائنين، وعادةً بلا تصويت. أنواعها: <strong>تراكمية</strong> (تتراكم المتأخرات) و<strong>قابلة للتحويل</strong>.'),
            L('Treasury stock (reacquired shares) reduces total equity — not an asset; has no vote, no dividends, no liquidation distribution. Recorded by cost or par method.',
              '<strong>أسهم الخزينة</strong> (أُعيد شراؤها) تُخفِّض حقوق الملكية وليست أصلًا، بلا تصويت ولا توزيعات ولا نصيب تصفية. تُسجَّل بـ<strong>طريقة التكلفة</strong> أو <strong>طريقة القيمة الاسمية</strong>، وتُقلّل الأسهم القائمة لا المصرَّح بها.'),
            L('Cash dividend: on declaration date RE ↓ and a liability arises; on payment date the liability and cash ↓. Record date has no accounting entry.',
              '<strong>التوزيع النقدي</strong>: في تاريخ <strong>الإعلان</strong> تنقص الأرباح المحتجزة وينشأ التزام؛ في تاريخ <strong>السداد</strong> ينقص الالتزام والنقد. أما تاريخ <strong>التسجيل</strong> فلا قيد له.'),
            L('Small stock dividend (<20–25%) uses fair value; large (>20–25%) uses par. Stock split changes par per share and share count but not total equity.',
              '<strong>توزيع أسهم صغير</strong> (أقل من 20–25%) يُعاد تصنيفه بالقيمة العادلة؛ و<strong>الكبير</strong> (أكثر) بالقيمة الاسمية. <strong>تجزئة الأسهم</strong> تُخفِّض القيمة الاسمية للسهم وتزيد العدد دون تغيير إجمالي حقوق الملكية (ولا قيد لها).'),
            L('Prior-period adjustments (error corrections, change in accounting principle) are retrospective and hit RE — not current net income. Changes in estimate are prospective.',
              '<strong>تسويات الفترات السابقة</strong> (تصحيح أخطاء أو تغيير مبدأ محاسبي) بأثر <strong>رجعي</strong> وتُعدَّل بها الأرباح المحتجزة لا دخل الفترة الحالية. أما <strong>تغيّر التقدير المحاسبي</strong> فبأثر <strong>مستقبلي</strong> فقط.'),
          ],
          note: 'أمثلة رقمية: إصدار 50,000 سهم قيمة اسمية 1$ بسعر 17$ → نقد +850,000، رأس مال عادي +50,000، APIC +800,000. • أسهم خزينة (سعر شراء 20$ > إصدار 17$، 5,000 سهم): بالتكلفة نقد −100,000 وخزينة +100,000؛ بالقيمة الاسمية خزينة +5,000، APIC −80,000، أرباح محتجزة −15,000. • توزيع أسهم صغير 10% على 45,000 سهم بسعر 15$: أرباح محتجزة −67,500، رأس مال +4,500، APIC +63,000. • توزيع عيني (أرض دفترية 50,000 وعادلة 80,000): إعادة تقييم +30,000 ربح ثم أرباح محتجزة −80,000 والتزام +80,000.'
        },
        {
          c: '1.5', title: 'Statement of Cash Flows', ar: 'قائمة التدفقات النقدية',
          lines: [
            L('Its purpose is to report cash receipts and payments, classified into operating, investing, and financing (in that presentation order).',
              'غرضها عرض المقبوضات والمدفوعات النقدية مصنَّفة إلى <strong>تشغيلية</strong> ثم <strong>استثمارية</strong> ثم <strong>تمويلية</strong> (هذا ترتيب العرض المقبول). وتُفسِّر التغيّر في النقد وما في حكمه وتُطابِق رصيد أوله بآخره.'),
            L('Operating cash flows come from the main revenue-producing activities and items entering net income.',
              '<strong>التشغيلية</strong> من النشاط الرئيسي المدرّ للإيراد: مقبوضات من بيع السلع/الخدمات والفوائد والتوزيعات المقبوضة؛ ومدفوعات للموردين والموظفين والضرائب وفوائد الدين.'),
            L('Investing cash flows relate to acquiring/disposing of long-lived assets and investments, and loans made to others.',
              '<strong>الاستثمارية</strong>: شراء/بيع الممتلكات والمعدات والأصول طويلة الأجل، وأدوات الملكية والدين لكيانات أخرى، والسلف والقروض الممنوحة للغير وتحصيلها.'),
            L('Financing cash flows relate to issuing/settling the entity’s own debt and equity, and paying dividends.',
              '<strong>التمويلية</strong>: متحصلات إصدار الأسهم والقروض والسندات؛ وسداد المبالغ المقترضة، ودفع التوزيعات النقدية، وإعادة شراء الأسهم، وسداد التزام الإيجار التمويلي.'),
            L('Indirect method: start from net income; add back noncash expenses/losses; subtract noncash gains; adjust for working-capital changes.',
              'الطريقة <strong>غير المباشرة</strong>: ابدأ من صافي الدخل، ثم أضِف <strong>زيادة الخصوم المتداولة ونقص الأصول المتداولة</strong> والمصروفات/الخسائر غير النقدية، واطرح <strong>زيادة الأصول المتداولة ونقص الخصوم المتداولة</strong> والمكاسب/الإيرادات غير النقدية — وهي الأشيع.'),
            L('Direct method lists actual operating cash receipts and payments; both methods give the same total operating cash flow.',
              'الطريقة <strong>المباشرة</strong> تسرد المقبوضات والمدفوعات الفعلية للتشغيل. الطريقتان تعطيان <strong>نفس إجمالي التدفق التشغيلي</strong>؛ الفرق في عرض القسم التشغيلي فقط.'),
            L('Significant noncash investing/financing activities (e.g., debt-to-equity conversion, asset acquired via lease) must be disclosed in the notes.',
              'أنشطة <strong>الاستثمار والتمويل غير النقدية</strong> (تحويل دين إلى ملكية، اقتناء أصل مقابل التزام أو إيجار، مبادلة أصل غير نقدي) يجب الإفصاح عنها في <strong>الإيضاحات</strong>.'),
          ],
          note: 'فخ شائع: الإهلاك ليس مصدرًا للنقد؛ يُضاف فقط لأنه خُصِم من صافي الدخل دون أن يستنزف نقدًا. • قيود القائمة: لا تكفي وحدها لتقدير الربحية أو السيولة الحقيقية، ويمكن التلاعب بعرضها، فتُقرأ مع باقي القوائم.'
        },
        {
          c: '1.6', title: 'Consolidation Accounting', ar: 'محاسبة الدمج',
          lines: [
            L('When one entity controls another, the parent issues consolidated statements regardless of ownership %, presenting parent + subsidiary as a single economic entity.',
              'عند <strong>سيطرة</strong> كيان على آخر، تُصدر الشركة الأم <strong>قوائم موحّدة</strong> بغض النظر عن نسبة الملكية، تعرض الأم والتابعة ككيان اقتصادي واحد (تطبيق «الجوهر فوق الشكل»).'),
            L('Control (VOE model) is usually direct/indirect ownership of more than 50% of voting interests; the VIE model applies control by power even without a voting majority.',
              '<strong>السيطرة</strong> عادةً ملكية مباشرة/غير مباشرة لأكثر من <strong>50%</strong> من حقوق التصويت (نموذج VOE). ويوجد نموذج <strong>VIE</strong> حيث تتحقق السيطرة بالقدرة على التوجيه عبر عقد لا بأغلبية تصويت.'),
            L('A business combination uses the acquisition method: identify acquirer and date; measure identifiable assets, liabilities, and NCI at fair value; recognize goodwill or a bargain-purchase gain.',
              'يُحاسَب عن الدمج بـ<strong>طريقة الاستحواذ</strong>: تحديد المستحوِذ وتاريخ الاستحواذ؛ قياس الأصول والخصوم المحددة و<strong>حصة الأقلية NCI</strong> بالقيمة العادلة؛ والاعتراف بالشهرة أو بربح من شراء مدعوم.'),
            L('Goodwill = (consideration + NCI fair value) − fair value of identifiable net assets. If negative, recognize a gain from a bargain purchase.',
              '<strong>الشهرة = (المقابل المحوّل + القيمة العادلة لحصة الأقلية) − القيمة العادلة لصافي الأصول المحددة</strong>. فإن كانت النتيجة سالبة يُعترف بـ<strong>ربح من شراء مدعوم</strong>.'),
            L('Consolidated income statement shows total net income split into amount attributable to NCI and amount attributable to the parent’s shareholders.',
              'قائمة الدخل الموحدة تعرض صافي الدخل الموحد مقسومًا إلى: الدائد لـ<strong>حصة الأقلية</strong> والعائد لـ<strong>مساهمي الأم</strong>.'),
            L('Intraentity balances, transactions, unrealized inventory profit, asset-transfer gains/losses, intercompany debt, and reciprocal dividends are eliminated in full.',
              'تُحذف <strong>بالكامل</strong> الأرصدة والمعاملات الداخلية: المدينون/الدائنون المتبادلون، مجمل الربح غير المحقق في المخزون المتبقي، أرباح/خسائر نقل الأصول، ديون الشركات ببعضها، والتوزيعات المتبادلة.'),
            L('Related methods: equity method for significant influence (20%–50%), and proportionate consolidation for joint ventures.',
              'طرق ذات صلة: <strong>طريقة حقوق الملكية</strong> عند التأثير الجوهري (ملكية 20%–50%) دون إعداد قوائم موحّدة، و<strong>الدمج التناسبي</strong> للمشروعات المشتركة بحسب نسبة المشاركة.'),
          ],
          note: 'مثال الشهرة: استحواذ 80% مقابل 192,000، وحصة أقلية عادلة 48,000 → 240,000؛ صافي أصول محددة (350,000 − 140,000) = 210,000 → الشهرة = 30,000. • مثال شراء مدعوم: لو كانت الأصول العادلة 400,000 فصافي الأصول = 260,000 والمقابل + الأقلية = 240,000 → ربح 20,000. • مثال توزيع صافي الدخل: صافي دخل التابعة 26,000؛ حصة الأقلية 20% = 5,200؛ والعائد لمساهمي الأم = 39,000 + (26,000 × 80%) = 59,800. (لا يُطلب في امتحان CMA إعداد قوائم موحّدة أو حساب NCI، بل فهم عام لعملية الدمج.)'
        },
      ]
    },
...

    {
      ...
      sections: [
        ...
        },
        {
          ...
          note: 'مرتبط مباشرة بنشاطك: مقاولات بنيان — عقود الإنشاء تُعترف عادةً بنسبة الإنجاز (Over time) لا عند التسليم النهائي.'
        },
        {
      ...
      sections: [
        {
          ...
          note: 'مناسب لنشاط بنيان: كل مشروع مقاولات = أمر إنتاجي تُجمَّع تكاليفه على حدة لقياس ربحيته.'
        },
        {
        ...
        },
        {
          ...
          lines: [
            ...
            L('ERP integrates all business functions in one shared database in real time.',
              'أنظمة <strong>ERP</strong> تدمج كل وظائف الشركة (محاسبة، مخزون، مشتريات، موارد بشرية) في <strong>قاعدة بيانات موحّدة فورية</strong> — وهذا جوهر تطبيق بُنيان نفسه.'),
          ]
        },
      ]
    },
      ...
      sections: [
        {
          ...
          lines: [
            ...
            L('ERP unifies finance, supply chain, HR, and operations into one integrated platform.',
              '<strong>ERP</strong> يوحّد المالية وسلسلة الإمداد والموارد البشرية والعمليات في <strong>منصّة متكاملة</strong> — وهو بالضبط ما يفعله نظام بُنيان.'),
          ]
        },
        {
